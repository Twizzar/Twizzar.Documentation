...
The extension should now be available from the Extensions menu:
...
After installing the extension, you are ready to create your first test with TWIZZAR. To do this, right-click on the method you want to test and select "Create Unit Test" from the context menu. You also can use the shortcut <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>N</kbd>, <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>N</kbd>.
